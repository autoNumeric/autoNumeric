...
export const config = {
    ...
    capabilities: [
        {
            ...
            'wdio:devtoolsOptions': {
                headless: true, // Set to `true` to not see the Chrome window
            },
            //
    ...
    logLevels: {
        webdriver: 'info',
        '@wdio/static-server-service': 'info',
    ...
    jasmineOpts: {
        ...
        defaultTimeoutInterval: 5000, // 1000 * 60 * 3
        //
    ...
    onPrepare: (config, capabilities) => {
        ...
        console.log("Launching the end-to-end tests"); //DEBUG
    },
    /**
    ...
    beforeHook: (test, context) => {
        ...
        /* browser.addCommand('getCaretPosition', function() { //FIXME Test this
    ...
    onComplete: (exitCode, config, capabilities, results) => {
        // eslint-disable-next-line
        console.log("End-to-end tests completed"); //DEBUG
    },
    /**
